...
describe DojosController do
  ...
  describe "index" do
    ...
    it "should assign @dojos" do
      assigns(:dojos).should ==  [{"latitude"=>-30.058381, "longitude"=>-51.175247}, {"latitude"=>-30.057963, "longitude"=>-51.174971}, {"latitude"=>-30.058497, "longitude"=>-51.17595}]
    end
